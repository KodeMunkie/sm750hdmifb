...
Each preview is shown at 50% page width; click it to open the original image.

### 1. Logical desktop

<a href="docs/images/desktop-2464x1080-logical.png"><img src="docs/images/desktop-2464x1080-logical.png" alt="Original 2464x1080 logical desktop" width="50%"></a>

The driver receives this original `2464x1080` logical desktop.

### 2. Compressed HDMI scanout

<a href="docs/images/desktop-2048x1080-scanout.png"><img src="docs/images/desktop-2048x1080-scanout.png" alt="The 2464x1080 desktop compressed to the SM750's 2048x1080 hardware scanout" width="50%"></a>
